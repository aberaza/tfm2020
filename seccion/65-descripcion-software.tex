...
\hfill
  ...
  \begin{subfigure}[b]{0.49\textwidth}
      \centering
      \pincludegraphics[1.0]{trainingModeloRNN}
...
\begin{figure}[!ht]
  ...
  \begin{subfigure}[b]{0.48\textwidth}
      \centering
      \pincludegraphics[1.0]{pruningModeloRNNRecon400_50}
      \caption{\footnotesize \label{fig:pruning:recon}Cribado del Modelo RNN Reconstrucción de \ifell/}
  \end{subfigure}
  \hfill
  \begin{subfigure}[b]{0.48\textwidth}
      \centering
      \pincludegraphics[1.0]{pruningModeloRNNPred400_50}
...
\tablan[0.6\textwidth]{tab:pruning:rmse}{Efecto del proceso en tamaño y RMSE de aplicar pruning por modelo}{lrrrr}{
                              & \multicolumn{2}{c}{\textit{Original}}   & \multicolumn{2}{c}{\textit{Pruned}} \\ \cmidrule[0.3pt](lr){2-3}\morecmidrules\cmidrule[0.3pt](lr){4-5}
...
\tablan[0.6\textwidth]{tab:quant:resultados}{Resultados de los modelos optimizados}{lrrrrr}{
                  &                       &               & \multicolumn{3}{c}{\textit{Latencia}}  \\ \cmidrule[0.3pt](lr){4-6}
  \textit{Modelo} &  \textit{Tamaño (MB)} & \textit{RMSE} &  CPU  &  GPU  & Wearable  \\ \midrule
  Base            & 11,1                  & 0,532         & -     &       &           \\
