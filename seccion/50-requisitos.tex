...
\tablan[0.85\linewidth]{tab:resumen_mod_anal}{Características de los modelos analíticos estudiados}{lccccccccll}{
          &       &     & \multicolumn{2}{c}{Estudio 1\tnote{1}} &\multicolumn{2}{c}{Estudio 2\tnote{2}} & \multicolumn{2}{c}{Estudio 3\tnote{3}} & \\
 Modelo  & Sens.\% & Esp.\%& Sens.\% & Esp.\% & Sens.\% & Esp.\% & Sens.\% & Esp.\% & Sensores & Postura \\ \hline
...
\warn{RECOMENDACIÓN: ponerlo en su sección (capítulo 4), aunque es únicamente una sugerencia. Podemos quizás dejarlo y poner algo similar en cada capítulo.} 
...
\todo{GRU como alternativa de mejor rendimiento a LSTM y mejor precisión que Tanh RNN}
