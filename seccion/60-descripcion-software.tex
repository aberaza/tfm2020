...
Este servicio realiza el análisis de la aceleración para detectar movimiento según el algoritmo definido en la figura \ref{fig:capturaFlow}. Tras cada muestra leida analiza el valor y analiza dos mecanismos de detección:
...
\begin{enumerate}
  ...
  \item \textbf{Movimiento prolongado} Activado cuando la aceleración promedio del contenido del buffer es superior a $0,2g$
\end{enumerate}
...
\begin{table}
  \subtabla[0.48]{tab:accelcapture:accel_session}{Descripción del Objeto AccelSession}{m{0.175\linewidth}m{0.15\linewidth}m{0.35\linewidth}}{
...
\subtabla[0.48]{tab:accelcapture:session_data}{Descripción del Objeto SessionData}{m{0.175\linewidth}m{0.15\linewidth}m{0.35\linewidth}}{
Campo           & Tipo Dato     & Descripción \\ \hline
