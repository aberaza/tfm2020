...
\node[text width=0.4cm] (obs4) at (0,-2) {\color{gray}{$\LARGE{\cdots}$}};
...
\node[text width=0.4cm] (obsn3) at (9,-2) {\color{gray}{$\LARGE{\cdots}$}};

\node[text width=0.4cm] (uu1) at (0,-0.8) {\color{gray}{$\LARGE{\cdots}$}};
\draw[] (1.5,-0.8) -- (1.5,-1.2);
\draw[] (3,-0.8) -- (3,-1.2);
\draw[] (4.5,-0.8) -- (4.5,-1.2);
\draw[] (6,-0.8) -- (6,-1.2);
\draw[] (7.5,-0.8) -- (7.5,-1.2);
\node[text width=0.4cm] (uu2) at (9,-0.8) {\color{gray}{$\LARGE{\cdots}$}};

\node[text width=0.4cm] (uuu1) at (0,0) {\color{gray}{$\LARGE{\cdots}$}};
...
\node[text width=0.4cm] (uuu2) at (9,0) {\color{gray}{$\LARGE{\cdots}$}};
...
\node[text width=0.4cm] (uuu3) at (9,2) {\color{gray}{$\LARGE{\cdots}$}};
\draw[] (4.5,0.8) -- (4.5,1.2);
\draw[] (6,0.8) -- (6,1.2);
\draw[] (7.5,0.8) -- (7.5,1.2);
