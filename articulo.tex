...
\begin{figure}
  ...
  \caption{\label{fig:} Arquitectura de la red RNN Codficador/Decodificador \ifell/}
\end{figure}
\begin{figure}
...
\begin{table}\caption{\label{tab:umbrales}Umbrales de decisión para Bourke y Modelos RNN}
  \resizebox{\columnwidth}{!}{
    \begin{tabular}{lcccc}\toprule
      ...
      (175u,50a,Pred) & 0,6956 & 1,6145 & 1,9264 & 2,2176  \\
      (175u,50a,Recons) & 0,0701 & 0,1404 & 0,2358 & 0,2822 \\ \bottomrule
    \end{tabular}
  }
\end{table}
